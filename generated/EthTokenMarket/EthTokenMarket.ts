...
export class EthTokenMarket__getUserRoundsResult {
  value0: Array<BigInt>;
  value1: BigInt;
...
export class EthTokenMarket__ledgerResult {
  value0: i32;
  value1: BigInt;
  value2: boolean;
...
export class EthTokenMarket__roundsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class EthTokenMarket extends ethereum.SmartContract {
  static bind(address: Address): EthTokenMarket {
    return new EthTokenMarket("EthTokenMarket", address);
  }
  ...
  bettable(epoch: BigInt): boolean {
    let result = super.call("bettable", "bettable(uint256):(bool)", [
  ...
  try_bettable(epoch: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("bettable", "bettable(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(epoch)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  closeInterval(): BigInt {
    let result = super.call("closeInterval", "closeInterval():(uint256)", []);

    return result[0].toBigInt();
  }

  try_closeInterval(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "closeInterval",
      "closeInterval():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getUserRounds(
    ...
    cursor: BigInt,
    size: BigInt
  ): EthTokenMarket__getUserRoundsResult {
    let result = super.call(
      "getUserRounds",
    ...
    return new EthTokenMarket__getUserRoundsResult(
  ...
  try_getUserRounds(
    ...
    cursor: BigInt,
    size: BigInt
  ): ethereum.CallResult<EthTokenMarket__getUserRoundsResult> {
    let result = super.tryCall(
      "getUserRounds",
      "getUserRounds(address,uint256,uint256):(uint256[],uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new EthTokenMarket__getUserRoundsResult(
  ...
  ledger(param0: BigInt, param1: Address): EthTokenMarket__ledgerResult {
    let result = super.call(
      "ledger",
    ...
    return new EthTokenMarket__ledgerResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_ledger(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<EthTokenMarket__ledgerResult> {
    let result = super.tryCall(
      "ledger",
      "ledger(uint256,address):(uint8,uint256,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EthTokenMarket__ledgerResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  lockInterval(): BigInt {
    let result = super.call("lockInterval", "lockInterval():(uint256)", []);

    return result[0].toBigInt();
  }

  try_lockInterval(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lockInterval", "lockInterval():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  oracleRoundId(): BigInt {
    let result = super.call("oracleRoundId", "oracleRoundId():(uint256)", []);

    return result[0].toBigInt();
  }

  try_oracleRoundId(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "oracleRoundId",
  ...
  rounds(param0: BigInt): EthTokenMarket__roundsResult {
    let result = super.call(
      "rounds",
    ...
    return new EthTokenMarket__roundsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rounds(
    param0: BigInt
  ): ethereum.CallResult<EthTokenMarket__roundsResult> {
    let result = super.tryCall(
      "rounds",
      "rounds(uint256):(uint256,uint256,uint256,uint256,int256,int256,uint256,uint256,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EthTokenMarket__roundsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  tokenPred(): Address {
    let result = super.call("tokenPred", "tokenPred():(address)", []);

    return result[0].toAddress();
  }

  try_tokenPred(): ethereum.CallResult<Address> {
    let result = super.tryCall("tokenPred", "tokenPred():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  tokenStaked(): Address {
    let result = super.call("tokenStaked", "tokenStaked():(address)", []);

    return result[0].toAddress();
  }

  try_tokenStaked(): ethereum.CallResult<Address> {
    let result = super.tryCall("tokenStaked", "tokenStaked():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class ConstructorCall__Inputs {
  ...
  get _tokenPred(): Address {
    return this._call.inputValues[1].value.toAddress();
  }

  get _tokenStaked(): Address {
  ...
  get _ownerAdminOperator(): Array<Address> {
    return this._call.inputValues[4].value.toAddressArray();
  }

  get _lockInterval(): BigInt {
    return this._call.inputValues[5].value.toBigInt();
  }

  get _closeInterval(): BigInt {
...
export class SetCloseIntervalCall extends ethereum.Call {
  get inputs(): SetCloseIntervalCall__Inputs {
    return new SetCloseIntervalCall__Inputs(this);
  }

  get outputs(): SetCloseIntervalCall__Outputs {
    return new SetCloseIntervalCall__Outputs(this);
  }
}

export class SetCloseIntervalCall__Inputs {
  _call: SetCloseIntervalCall;

  constructor(call: SetCloseIntervalCall) {
    this._call = call;
  }
...
export class SetCloseIntervalCall__Outputs {
  _call: SetCloseIntervalCall;
...
export class SetLockIntervalCall extends ethereum.Call {
  get inputs(): SetLockIntervalCall__Inputs {
    return new SetLockIntervalCall__Inputs(this);
  }

  get outputs(): SetLockIntervalCall__Outputs {
    return new SetLockIntervalCall__Outputs(this);
  }
}

export class SetLockIntervalCall__Inputs {
  _call: SetLockIntervalCall;

  constructor(call: SetLockIntervalCall) {
    this._call = call;
  }
...
export class SetLockIntervalCall__Outputs {
  _call: SetLockIntervalCall;
